...
const { flowTemplate, queue } = require("@kaholo/shared/dist/src/helpers/templates")
...
const storageSaveFlow = flowTemplate(
    queue("Storage/Save", {
      inputMapping: {
        id: "id",
    ...
    queue("Bigbird/Execution/UpdateLog", {
      vhost: VHOST.EVENTS,
      inputMapping: {
        type: "type",
        actionId: "actionId",
